...
@section('content')
    <div class="card">
        ...
        <div class="row mt-3 ml-2 mt-4 mb-1">
            <p class="col-12 mb-2 text-muted">Filter Data berdasarkan Tanggal</p>
            <p class="text-muted col-12">
                <b>Jumlah Pinjaman: </b> <span id="total_records"></span><br>
                <b>Jumlah Data: </b> <span id="jumlah_data"></span>
            </p>
            <div class="col-6">
                <div class="input-group my-2">
                    <select name="" id="category" hidden>
                        <option value="Pinjaman" selected>Pinjaman</option>
                    </select>
